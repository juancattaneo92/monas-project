            ...
            <section className="feature-1">
                <div className="feature-wrapper">
                    <div className="feature-image-container">
                        <img data-aos='zoom-in' data-aos-duration='500' className="feature-1-image" src={window.mugshot} alt="" />
                    </div>
...
If Da Vinci were still around, this would be his favorite burger spot, guaranteed.</p>
                        <button data-aos='zoom-out' data-aos-duration='500' data-aos-delay="100" className="action-button learn-more-button">Contact</button>
                    </div>
                </div>
            </section>
        )
